...
-- 4	to-delete-2	
-- 5	inserted-1	
-- visible uncommitted insert from session1
...
-- lock, there is uncommitted insert in table1 in session1
...
-- 5	inserted-1	
-- 6	inserted-2	
-- visible (uncommitted insert from session1) AND (uncommitted insert from session2)
...
-- dead lock if session2 started update/delete and waits for commit in session1
...
-- 6	inserted-2	
-- 7	inserted-1-2	
-- visible (uncommitted insert + insert from session1) AND (uncommitted insert from session2)
